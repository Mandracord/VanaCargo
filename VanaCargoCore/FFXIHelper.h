...
/*
	0x0000 - 0x0FFF  General Items 1
	0x1000 - 0x1FFF  Usable Item
	0x2000 - 0x21FF  Puppet Item
	0x2200 - 0x27FF  General Items 1
	0x2C00 - 0x3FFF  Armor 1
	0x4000 - 0x59FF  Weapons
	0x5A00 - 0x6FFF  Armor 2
	0x7000 - 0x73FF  Misc
*/
enum FFXI_ITEM_TYPE
{
	ITEM_TYPE_GENERAL_ITEMS_1 = 0,
	ITEM_TYPE_USABLE_ITEM,
	ITEM_TYPE_PUPPET_ITEM,
	ITEM_TYPE_GENERAL_ITEMS_2,
	ITEM_TYPE_ARMOR_1,
	ITEM_TYPE_WEAPON,
	ITEM_TYPE_ARMOR_2,
	ITEM_TYPE_COUNT
...
/*
	0x0001 = Can be placed on mog house wall
	0x0002 = ?
	0x0004 = Can be obtained from Goblin Mystery Box
	0x0008 = Can be used in Mog Garden
	0x0010 = Can mail within same POL account
...
{
public:
	FFXiHelper(int Region = FFXI_REGION_US)
	{
		m_Region = Region;
	}
